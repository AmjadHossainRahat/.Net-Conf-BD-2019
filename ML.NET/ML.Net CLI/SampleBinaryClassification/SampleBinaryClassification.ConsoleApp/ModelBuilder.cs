...
namespace SampleBinaryClassification.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\Repo\.Net-Conf-BD-2019\ML.NET\ML.Net CLI\sentiment-analysis-wiki-250-line-data.tsv";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.LinearSvm(new LinearSvmTrainer.Options() { Lambda = 0.01751406f, PerformProjection = false, NoBias = false, NumberOfIterations = 16, InitialWeightsDiameter = 0.332249f, Shuffle = false, LabelColumnName = "Sentiment", FeatureColumnName = "Features" });
