...
namespace AutoMLTestML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\Repo\.Net-Conf-BD-2019\ML.NET\AutoML\Data\sentiment-analysis-wiki-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"../../../../AutoMLTestML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.SgdCalibrated(new SgdCalibratedTrainer.Options() { L2Regularization = 5E-06f, ConvergenceTolerance = 0.0001f, NumberOfIterations = 5, Shuffle = true, LabelColumnName = "Sentiment", FeatureColumnName = "Features" });
